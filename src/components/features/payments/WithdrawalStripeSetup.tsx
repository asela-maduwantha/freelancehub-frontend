...
const WithdrawalStripeSetup: React.FC<WithdrawalStripeSetupProps> = ({
  ...
  if (!stripeStatus?.hasAccount) {
    return (
      <div className="bg-white rounded-lg shadow-md p-8 text-center max-w-2xl mx-auto border border-gray-200">
        ...
        <div className="bg-primary-50 border border-primary-100 rounded-lg p-4 mb-6">
          ...
          <ul className="text-sm text-gray-700 text-left space-y-1 max-w-md mx-auto">
  ...
  // Account is ready (this shouldn't normally display, but just in case)
  return (
