      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">
            Withdrawal #{String(withdrawal._id).slice(-8)}
          </h3>
        ...
        <div className="mb-6">
          ...
          <div className="bg-primary-50 rounded-lg p-4 space-y-3 border border-gray-200">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            {/* Requested */}
            <div className="flex items-start">
              <div className="flex-shrink-0 w-8 h-8 bg-primary-light rounded-full flex items-center justify-center mr-3">
                <svg
            ...
            {withdrawal.completedAt && (
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 bg-secondary-light rounded-full flex items-center justify-center mr-3">
                  <svg
        ...
        {withdrawal.description && (
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 bg-primary-50 p-3 rounded-lg border border-gray-200">
              {withdrawal.description}
            </p>
          </div>
        )}
