...
const FAQ: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-50/30 via-blue-100/40 to-blue-50/30 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-12 right-12 w-32 h-32 bg-gradient-to-br from-blue-400/8 to-blue-500/8 rounded-full blur-3xl"></div>
        <div className="absolute bottom-12 left-12 w-40 h-40 bg-gradient-to-br from-blue-500/8 to-blue-600/8 rounded-full blur-3xl"></div>
        <div className="absolute top-1/3 left-1/4 w-24 h-24 bg-gradient-to-br from-blue-300/6 to-blue-400/6 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/4 w-28 h-28 bg-gradient-to-br from-blue-400/6 to-blue-500/6 rounded-full blur-3xl"></div>
      </div>

      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-4">
            Frequently Asked <span className="bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">Questions</span>
          </h2>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/3 to-blue-600/3 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

              <button
                className="w-full px-8 py-6 text-left flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-blue-500/50 rounded-2xl transition-all duration-300 relative z-10"
                onClick={() => toggleFAQ(index)}
              >
                <span className="text-lg font-semibold text-gray-800 group-hover:text-blue-600 transition-colors duration-300 pr-4">
                  {faq.question}
                </span>
                <div className="flex-shrink-0">
                  <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center shadow-md group-hover:shadow-blue-500/30 transform group-hover:scale-110 transition-all duration-300">
              ...
              <div className={`absolute bottom-0 left-4 right-4 h-0.5 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full transition-all duration-500 ${
        ...
        <div className="text-center mt-12 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
          ...
          <Button
            variant="accent"
            size="lg"
            className="inline-flex items-center space-x-2 px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300"
          >
