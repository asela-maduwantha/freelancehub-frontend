                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">${contract.paidAmount.toLocaleString()}</p>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="flex justify-between text-sm text-gray-600 mb-1">
                        <span>Progress</span>
                        <span>{Math.round((contract.paidAmount / contract.totalAmount) * 100)}%</span>
                      </div>
                    ...
                    <div className="flex space-x-2 pt-2">
                      ...
                      <Link href={`/contracts/${contract._id}/messages`} className="flex-1">
