      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] px-4 py-12">
        ...
        >
          ...
          <div className="mt-6 p-4 bg-emerald-50 rounded-lg">
            <h4 className="font-semibold text-emerald-800 mb-2 font-poppins">What's Next?</h4>
            <ul className="text-sm text-emerald-700 space-y-1 font-inter">
              <li>• Verify your email address</li>
              <li>• Complete your professional profile</li>
              <li>• Add your skills and portfolio</li>
              <li>• Start browsing and applying to projects</li>
            </ul>
          </div>
